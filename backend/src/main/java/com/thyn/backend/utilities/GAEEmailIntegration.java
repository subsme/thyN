...
public class GAEEmailIntegration {
    private String from,
            subject,
            text,
            html;
    ...
    protected String domain = "https://www.yanchware.com/",
            endpoint= "emailEndpoint.php",
            username,
            password;

    GAEEmailIntegration(String username, String password) {
     ...
     * @return           The SendEmailIntegration object.
     */
    public GAEEmailIntegration setTo(String email) {
     ...
     * @return           The SendEmailIntegration object.
     */
    public GAEEmailIntegration addTo(String email, String name) {
     ...
     * @return          The SendEmailIntegration object.
     */
    public GAEEmailIntegration addTo(String email) {
        return addTo(email, "");
    }
     ...
     * @return           The SendEmailIntegration object.
     */
    public GAEEmailIntegration setFrom(String email) {
        this.from = email;
     ...
     * @return            The SendEmailIntegration object
     */
    public GAEEmailIntegration setSubject(String subject) {
     ...
     * @return         The SendEmailIntegration object.
     */
    public GAEEmailIntegration setText(String text) {
        this.text = text;
     ...
     * @return         The SendEmailIntegration object.
     */
    public GAEEmailIntegration setHtml(String html) {
        this.html = html;
